...
export class Application {
    ...
    parseCourses(resourceObject: CourseData) {
        ...
        for (const courseID in resourceObject) {
            ...
            const degreeName = resourceObject[courseID].degreeName;
            ...
            const course = new Course(
                ...
                courseAssignmentOptions, courseHours, courseHoursReq, degreeName
            );
...
fetch("./HS24.json").then(res => res.json()).then((courseData: CourseData) => {
